...
<!-- {#if style === 'line'}
	...
	{#if icon === '    '}
		plus<small
			class="absolute top-px right-px mt-1 mr-1 rounded-full text-xs leading-5 font-medium px-2 pointer-events-none bg-yellow-100 text-orange-700 transition-opacity duration-200"
